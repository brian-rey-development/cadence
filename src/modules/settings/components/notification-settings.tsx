...
export default function NotificationSettings({
  ...
  return (
    <div className="flex flex-col gap-1">
      <p className="font-[family-name:var(--font-body)] text-xs font-medium uppercase tracking-widest text-[var(--color-text-tertiary)]">
        Notifications
      </p>
          ...
          <div className="flex items-center gap-3">
            {snapshot.morningEnabled && (
              <input
                ...
                className="rounded-lg bg-[var(--color-bg-base)] px-2 py-1 font-['DM_Mono'] text-sm text-[var(--color-text-secondary)] outline-none"
              />
            )}
            <button
              type="button"
