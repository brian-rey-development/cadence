  ...
  return (
    <div className="flex min-h-svh flex-col items-center justify-center gap-4 px-5 text-center bg-[var(--color-bg-base)]">
      ...
      <button
        type="button"
        onClick={reset}
        className="h-11 px-6 rounded-full bg-[var(--color-primary-bg)] text-primary-text text-sm font-medium font-body transition-colors hover:bg-[var(--color-primary-hover)]"
      >
        Try again
      </button>
    </div>
